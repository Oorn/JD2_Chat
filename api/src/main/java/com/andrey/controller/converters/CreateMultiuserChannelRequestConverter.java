...
public class CreateMultiuserChannelRequestConverter implements Converter<CreateMultiuserChannelRequest, ChatChannel> {
    @Override
    public ChatChannel convert(CreateMultiuserChannelRequest source) {
